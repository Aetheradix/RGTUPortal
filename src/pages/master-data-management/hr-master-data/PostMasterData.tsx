...
import { postMasterMockData } from "./data";
import { getPostMasterColumns } from "./table";
...
const PostMaster: React.FC = () => {
  ...
  return (
    <PageLayout title="Post Master Data">
      <Toast ref={toast} />
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
          ...
          <Table
            data={postMasterMockData}
            // eslint-disable-next-line react-hooks/refs
            columns={getPostMasterColumns(showDeniedToast)}
            showPagination={true}
            rowsPerPage={10}
