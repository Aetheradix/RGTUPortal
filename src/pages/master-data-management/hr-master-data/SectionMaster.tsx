...
import { sectionMasterMockData } from "./data";
import { getSectionMasterColumns } from "./table";
...
const SectionMaster: React.FC = () => {
  ...
  return (
    <PageLayout title="Section Master Data">
      <Toast ref={toast} />
      ...
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
          ...
          <Table
            data={sectionMasterMockData}
            // eslint-disable-next-line react-hooks/refs
            columns={getSectionMasterColumns(showDeniedToast)}
            showPagination={true}
            rowsPerPage={10}
