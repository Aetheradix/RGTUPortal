...
import { payScaleMasterMockData } from "./data";
import { getPayScaleColumns } from "./table";

const PayScaleMaster: React.FC = () => {
    ...
    <PageLayout title="Pay Scale Master Data">
      ...
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
          ...
          <Table
            data={payScaleMasterMockData}
            // eslint-disable-next-line react-hooks/refs
            columns={getPayScaleColumns(showDeniedToast)}
            showPagination={true}
            rowsPerPage={10}
