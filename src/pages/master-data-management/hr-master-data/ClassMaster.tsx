...
import { classMasterMockData } from "./data";
import { getClassMasterColumns } from "./table";
...
const ClassMaster: React.FC = () => {
  ...
  return (
    <PageLayout title="Class Master Data">
      <Toast ref={toast} />
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
          ...
          <Table
            data={classMasterMockData}
            // eslint-disable-next-line react-hooks/refs
            columns={getClassMasterColumns(showDeniedToast)}
            showPagination={true}
            rowsPerPage={10}
