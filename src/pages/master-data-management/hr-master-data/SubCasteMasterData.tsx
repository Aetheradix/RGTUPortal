...
import { subCasteMasterMockData } from "./data";
import { getSubCasteColumns } from "./table";

const SubCasteMaster: React.FC = () => {
    ...
    <PageLayout title="Sub Caste Master Data">
      ...
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
          ...
          <Table
            data={subCasteMasterMockData}
            // eslint-disable-next-line react-hooks/refs
            columns={getSubCasteColumns(showDeniedToast)}
            showPagination={true}
            rowsPerPage={10}
