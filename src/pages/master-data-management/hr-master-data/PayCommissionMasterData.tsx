...
import { payCommissionMasterMockData } from "./data";
import { getPayCommissionColumns } from "./table";

const PayCommissionMaster: React.FC = () => {
  ...
  return (
    <PageLayout title="Pay Commission Master Data">
      <Toast ref={toast} />
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
          ...
          <Table
            data={payCommissionMasterMockData}
            // eslint-disable-next-line react-hooks/refs
            columns={getPayCommissionColumns(showDeniedToast)}
            showPagination={true}
            rowsPerPage={10}
...
export default PayCommissionMaster;
