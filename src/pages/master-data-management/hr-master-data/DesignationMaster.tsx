...
import { designationMasterMockData } from "./data";
import { getDesignationMasterColumns } from "./table";
...
const DesignationMaster: React.FC = () => {
  ...
  return (
    <PageLayout title="Designation Master Data">
      <Toast ref={toast} />
      ...
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
          ...
          <Table
            data={designationMasterMockData}
            // eslint-disable-next-line react-hooks/refs
            columns={getDesignationMasterColumns(showDeniedToast)}
            showPagination={true}
            rowsPerPage={10}
