...
import { levelMasterMockData } from "./data";
import { getLevelMasterColumns } from "./table";

const LevelMaster: React.FC = () => {
    ...
    <PageLayout title="Level Master Data">
      ...
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
          ...
          <Table
            data={levelMasterMockData}
            // eslint-disable-next-line react-hooks/refs
            columns={getLevelMasterColumns(showDeniedToast)}
            showPagination={true}
            rowsPerPage={10}
