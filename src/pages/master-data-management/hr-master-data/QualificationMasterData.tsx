...
import { qualificationMasterMockData } from "./data";
import { getQualificationColumns } from "./table";
...
const QualificationMaster: React.FC = () => {
  ...
  return (
    <PageLayout title="Qualification Master Data">
      <Toast ref={toast} />
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
          ...
          <Table
            data={qualificationMasterMockData}
            // eslint-disable-next-line react-hooks/refs
            columns={getQualificationColumns(showDeniedToast)}
            showPagination={true}
            rowsPerPage={10}
