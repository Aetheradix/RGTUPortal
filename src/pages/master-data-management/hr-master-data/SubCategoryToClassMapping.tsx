...
import { getSubCategoryColumns } from "./table";

const SubCategoryMappingMaster: React.FC = () => {
  ...
  return (
    <PageLayout title="School Sub Category Master Data">
      <Toast ref={toast} />
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
          ...
          <Table
            ...
            columns={getSubCategoryColumns(showDeniedToast)}
            showPagination={true}
            rowsPerPage={10}
...
export default SubCategoryMappingMaster;
