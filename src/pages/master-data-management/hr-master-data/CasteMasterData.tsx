...
import { casteMasterMockData } from "./data";
import { getCasteMasterColumns } from "./table";
...
const CasteMaster: React.FC = () => {
  ...
  return (
    <PageLayout title="Caste Master Data">
      <Toast ref={toast} />
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
          ...
          <Table
            data={casteMasterMockData}
            // eslint-disable-next-line react-hooks/refs
            columns={getCasteMasterColumns(showDeniedToast)}
            showPagination={true}
            rowsPerPage={10}
