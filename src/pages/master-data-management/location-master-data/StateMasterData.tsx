...
import { stateMockData } from "./data";
import { getStateColumns } from "./table";
...
const StateMaster: React.FC = () => {
  ...
  const handleEdit = (data: any) => {
    console.log("Editing State:", data.stateNameEn);
    setFormData({
      stateNameEn: data.stateNameEn,
      stateNameHi: data.stateNameHi,
  ...
  const handleSave = () => {
    if (!formData.stateNameEn || !formData.stateNameHi || !formData.stateCode) {
      toast.current?.show({
        severity: "error",
      ...
      {step === 1 && (
        <div className="space-y-4 animate-fade-in">
          ...
          <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
            ...
            <Table
              data={stateMockData}
              columns={getStateColumns(handleEdit)}
              showPagination={true}
              rowsPerPage={10}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div className="flex flex-col gap-2">
                ...
                <InputText
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, stateNameEn: e.target.value })
                  }
              ...
              <div className="flex flex-col gap-2">
                <label className="text-blue-600 text-xs font-bold">
                  State Name (In हिन्दी) <span className="text-red-500">*</span>
                </label>
                <InputText
                  value={formData.stateNameHi}
                  onChange={(e) =>
                    setFormData({ ...formData, stateNameHi: e.target.value })
                  }
