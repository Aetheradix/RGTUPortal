...
import { schoolCategoryMockData } from "./data";
import { getSchoolCategoryColumns } from "./table";

const SchoolCategoryMaster: React.FC = () => {
    ...
    <PageLayout title="School Category Master Data">
      ...
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
          ...
          <Table
            data={schoolCategoryMockData}
            // eslint-disable-next-line react-hooks/refs
            columns={getSchoolCategoryColumns(showDeniedToast)}
            showPagination={true}
            rowsPerPage={10}
...
export default SchoolCategoryMaster;
