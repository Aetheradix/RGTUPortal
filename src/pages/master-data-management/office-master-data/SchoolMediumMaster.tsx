...
import { schoolMediumMockData } from "./data";
import { getSchoolMediumColumns } from "./table";

const SchoolMediumMaster: React.FC = () => {
    ...
    <PageLayout title="School Medium Master Data">
      ...
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
          ...
          <Table
            data={schoolMediumMockData}
            // eslint-disable-next-line react-hooks/refs
            columns={getSchoolMediumColumns(showDeniedToast)}
            showPagination={true}
            rowsPerPage={10}
...
export default SchoolMediumMaster;
