...
import { schoolManagementGroupMockData } from "./data";
import { getSchoolManagementGroupColumns } from "./table";

const SchoolManagementGroupMaster: React.FC = () => {
  ...
  return (
    <PageLayout title="School Management Group Master Data">
      <Toast ref={toast} />
      ...
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
          ...
          <Table
            data={schoolManagementGroupMockData}
            // eslint-disable-next-line react-hooks/refs
            columns={getSchoolManagementGroupColumns(showDeniedToast)}
            showPagination={true}
            rowsPerPage={10}
...
export default SchoolManagementGroupMaster;
