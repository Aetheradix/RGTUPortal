...
import { schoolSubCategoryMockData } from "./data";
import { getSchoolSubCategoryColumns } from "./table";

const SchoolSubCategoryMaster: React.FC = () => {
    ...
    <PageLayout title="School Sub Category Detail Master Data">
      ...
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="bg-white p-4 rounded shadow-sm border border-gray-100">
          ...
          <Table
            data={schoolSubCategoryMockData}
            // eslint-disable-next-line react-hooks/refs
            columns={getSchoolSubCategoryColumns(showDeniedToast)}
            showPagination={true}
            rowsPerPage={10}
...
export default SchoolSubCategoryMaster;
