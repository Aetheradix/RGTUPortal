...
import { eventData, eventTypeOptions, priorityOptions } from "./data";
import { eventColumns } from "./DashboardTable";

const EventInformationMaster: React.FC = () => {
  ...
  const handleSave = () => {
    toast.current?.show({
      severity: "success",
      summary: "Success",
      detail: "Event Information saved successfully",
      life: 3000,
    });
    setStep(1);
  };
  ...
  return (
    <PageLayout title="Event Information Master">
      <Toast ref={toast} />
...
export default EventInformationMaster;
