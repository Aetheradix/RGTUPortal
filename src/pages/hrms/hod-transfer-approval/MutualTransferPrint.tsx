...
import { mutualPrintOrderData, mutualPrintOrderColumns } from "./tables";

const MutualTransferPrintOrder: React.FC = () => {
  ...
  return (
    <PageLayout title="Mutual Transfer Print Order">
      <Toast ref={toast} />
        ...
        <div className="bg-white p-6 rounded shadow-sm border border-gray-100 mt-6 animate-fade-in">
          <div className="flex justify-between items-center mb-1 pb-2">
            <h3 className="text-md font-semibold text-gray-700">
              Employee Transfer Order Details
            </h3>
          </div>
          ...
          <div className="flex justify-end items-center mb-4">
            <div className="flex items-center gap-2 text-sm">
              <span>Search:</span>
              <InputText className="p-inputtext-sm border-gray-300" />
            </div>
          </div>

          <Table
            data={mutualPrintOrderData}
            columns={mutualPrintOrderColumns}
            showPagination={true}
            rowsPerPage={10}
...
export default MutualTransferPrintOrder;
