...
import { mutualFinalApprovalData } from "./data";
import Input from "@/ui/shared/Input";
import { mutualApproveColumns } from "./TransferTable";
import Table from "@/ui/shared/Table";

const MutualTransferFinalApprove: React.FC = () => {
  ...
  return (
    <PageLayout title="Mutual Transfer Final Approval">
      <Toast ref={toast} />
      ...
      {step === 2 && (
        <div className="bg-white p-6 rounded shadow-sm border border-gray-100 mt-6 animate-fade-in overflow-x-auto">
          <h3 className="text-lg font-semibold text-gray-700 mb-1 pb-4">
          ...
          <Table
            data={mutualFinalApprovalData}
            columns={mutualApproveColumns}
            showPagination={true}
            rowsPerPage={10}
            ...
            <Button
              ...
              onClick={() => {
                ...
                toast.current?.show({
                  severity: "success",
                  summary: "Verified",
                  detail: "Transfer Application Approved successfully.",
                  life: 3000,
                });
                setOtpValue("");
              }}
...
export default MutualTransferFinalApprove;
