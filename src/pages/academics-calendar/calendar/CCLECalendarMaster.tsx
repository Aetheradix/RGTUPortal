...
const CCLECalendarMaster: React.FC = () => {
  ...
  const [rows] = useState<CCLECalendarRow[]>([
    {
      ...
      title: "स्वास्थ्य",
      subTitle: "स्वास्थ्य",
      day: "First Saturday (2025-07-05)",
      activity: "निबंध",
      markingSystem: "व्यक्तिगत",
      activityMarks: 10,
    },
    {
      monthYear: "July (2025)",
      title: "आहार",
      subTitle: "आहार",
      day: "Second Saturday (2025-07-12)",
      activity: "आहार",
      markingSystem: "व्यक्तिगत",
      activityMarks: 10,
    },
    {
      monthYear: "July (2025)",
      title: "स्वस्थ दिनचर्या",
      subTitle: "स्वस्थ दिनचर्या",
      day: "Third Saturday (2025-07-19)",
      activity: "स्वस्थ दिनचर्या",
      markingSystem: "व्यक्तिगत",
      activityMarks: 10,
    },
    {
      monthYear: "July (2025)",
      title: "खेल गतिविधि",
      subTitle: "खेल कूद गतिविधि",
      day: "Fourth Saturday (2025-07-26)",
      activity: "खेल",
      markingSystem: "व्यक्तिगत",
      activityMarks: 20,
    },
    {
      ...
      title: "Swastha Dincharya",
      subTitle: "Swasth dincharya",
      day: "First Saturday (2025-08-02)",
      activity: "Pranayam",
      markingSystem: "व्यक्तिगत",
      activityMarks: 15,
    },
  ...
  return (
    <PageLayout title="CCLE Calendar">
      <div className=" rounded-xl bg-white relative mb-8">
        ...
        {showForm ? (
          <div className=" rounded-xl  bg-white relative mb-8">
            <div className="   font-bold pb-6">
              <span className="font-bold ">
                Add Continuous and Comprehensive Learning and Evaluation (CCLE)
                Calendar
              </span>
            </div>
          ...
          <div className="rounded-xl bg-white overflow-hidden mt-8">
            <div className=" border-b border-gray-100 bg-white flex flex-col gap-2">
              ...
              <p className="text-blue-700 font-bold text-xs">
                * Note:- Data for the Current Academic Year (2025-26) is shown
                below.
              </p>
            </div>
