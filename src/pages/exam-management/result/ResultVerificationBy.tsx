            ...
            <Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                  ...
                  <InputText value="Amit Kumar" disabled />
                </div>

                <div>
                  <label className="block text-sm mb-1">Select Subject</label>
                  <InputText value="Data Structures" disabled />
                </div>
                ...
                <div>
                  <label className="block text-sm mb-1">Examination Date *</label>
                  <Calendar dateFormat="dd/mm/yy" className="w-full" />
                </div>

                <div>
                  <label className="block text-sm mb-1">Verification Status *</label>
                  <Dropdown options={verificationStatusOptions} placeholder="Select" />
                </div>
              </div>
