...
export default function SchemeApplicationStudentStatusReport() {
  ...
  const schools = [
    { label: "All", value: "All" },
    { label: "Govt HS Bhopal", value: "Govt HS Bhopal" },
    { label: "Model School Agar", value: "Model School Agar" },
  ];
  ...
  return (
    <Card title="Sanctioned Scholarship Status Report">
      ...
      {showList && (
        <div className="animate-fadein mt-6">
          <Table
            title="Sanctioned Scholarship List"
