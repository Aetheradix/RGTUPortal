      ...
      {!showAdd ? (
          ...
          <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
            <div className="flex justify-between items-center mb-6 border-b pb-4">
              <h2 className="text-xl font-bold text-gray-800">
                Driver Attender Registration List
              </h2>
              <Button
                label="Add Driver Attender Registration"
                icon="pi pi-plus"
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
            <div className="flex justify-between items-center mb-6 border-b pb-4">
              <h2 className="text-xl font-bold text-gray-800">
                Add Driver Attender Registration
              </h2>
              <Button
                label="Go Back"
            ...
            <div className="space-y-8">
              <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
                <h4 className="text-md font-bold mb-6 text-gray-700 border-l-4 border-blue-500 pl-3">
                  Basic Information
                </h4>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-x-4 gap-y-6">
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-sm font-semibold text-gray-700">
                      Driver Name (English) <span className="text-red-500">*</span>
                    </label>
                    <InputText placeholder="Enter Name" className="w-full" />
                  </div>
                  <div className="flex flex-col gap-2">
                    <label className="text-sm font-semibold text-gray-700">
                      ड्राइवर का नाम (हिंदी) <span className="text-red-500">*</span>
                    </label>
