...
import { getVerificationColumns } from "./table";
...
const EmployeeVerification: React.FC = () => {
  ...
  const onReject = (data: any) => console.log("Rejecting:", data.employeeName);
  const onApprove = (data: any) => {
    toast.current?.show({
      severity: "success",
      summary: "Approved",
      detail: `${data.employeeName} verified.`,
    });
  };
    ...
    <PageLayout title="Employee Verification Details">
      ...
      <div className="bg-white p-6 rounded shadow-sm border border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="flex flex-col gap-2">
            <label className="text-xs font-bold text-gray-500">
              Select Division Name (Code)<span className="text-red-500">*</span>
            </label>
            <Dropdown
          ...
          <div className="flex flex-col gap-2">
            <label className="text-xs font-bold text-gray-500">
              Select District Name (Code)<span className="text-red-500">*</span>
            </label>
            <Dropdown
      ...
      {step === 2 && (
        <div className="bg-white p-6 rounded shadow-sm border border-gray-100 mt-6 animate-fade-in">
          ...
          <Table
            ...
            columns={getVerificationColumns(onReject, onApprove)}
            showPagination={true}
            rowsPerPage={10}
            rowClassName={(data: any) => data.rowClass}
