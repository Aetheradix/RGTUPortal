...
import { getDistrictWiseIdColumns } from "./table";
import { districtData } from "./data";

const DistrictWiseIdCard: React.FC = () => {
  const toast = useRef<Toast>(null);

  return (
    <PageLayout title="District Wise ID Card Details">
      <Toast ref={toast} />
      ...
      <div className="bg-white p-6 rounded shadow-sm border border-gray-100 animate-fade-in">
        ...
        <Table
          data={districtData}
          columns={getDistrictWiseIdColumns}
          showPagination={true}
          rowsPerPage={50}
...
export default DistrictWiseIdCard;
