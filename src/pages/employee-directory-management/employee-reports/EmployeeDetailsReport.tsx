...
import { employeeReportData } from "./data";
import { employeeReportColumns } from "./table";
import {
  blockOptions,
  districtOptions,
  divisionOptions,
...
const EmployeeDetailsReport: React.FC = () => {
