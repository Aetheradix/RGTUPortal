...
import { verificationDetailData } from "./data";
import { getVerificationDetailColumns } from "./table";
import {
  oisOptions,
  divisionOptions,
  districtOptions,
...
const EmployeeVerificationReport: React.FC = () => {
  ...
  const handleSearch = () => {
    ...
    toast.current?.show({
      severity: "success",
      summary: "Success",
      detail: "Verification details fetched successfully",
      life: 2000,
    });
  };
  ...
  const onViewDetail = (data: any) => console.log("Viewing:", data.nameCode);
  const onPrintCard = (data: any) =>
    console.log("Printing card for:", data.nameCode);

  return (
    <PageLayout title="Employee Verification Details">
      <Toast ref={toast} />

      <div className="bg-white p-6 rounded shadow-sm border border-gray-100">
        <h4 className="text-blue-600 font-bold mb-4 border-b pb-2 text-md">
          Search Employee Verification
        </h4>
      ...
      {step === 2 && (
        <div className="bg-white p-6 rounded shadow-sm border border-gray-100 mt-6 animate-fade-in">
          ...
          <Table
            ...
            columns={getVerificationDetailColumns(onViewDetail, onPrintCard)}
            showPagination={true}
            rowsPerPage={50}
...
export default EmployeeVerificationReport;
