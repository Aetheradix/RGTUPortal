        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center border-t pt-4">
          ...
          <div className="flex items-center gap-2">
            <Checkbox
              ...
              checked={openingBal}
            />
            <label htmlFor="cb1" className="text-xs font-bold text-gray-600">
              Opening Bal.
            </label>
          </div>
          <div className="flex items-center gap-2">
            <Checkbox
              ...
              checked={transaction}
            />
            <label htmlFor="cb2" className="text-xs font-bold text-gray-600">
              Transaction
            </label>
          </div>
          <div className="flex items-center gap-2">
            <Checkbox
              ...
              checked={closingBal}
            />
            <label htmlFor="cb3" className="text-xs font-bold text-gray-600">
              Closing Bal.
            </label>
          </div>
        </div>
      ...
      {step === 2 && (
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 mt-6 overflow-x-auto">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-xs text-gray-500">01-04-2024 To 31-06-2023</p>
          </div>
          ...
          >
            ...
            />
            <Column field="openingBalance" header="Opening Balance" sortable />
            <Column
              field="debitAmount"
            ...
            <Column
              ...
              sortable
            />
            <Column field="closingBalance" header="Closing Balance" sortable />
          </DataTable>
